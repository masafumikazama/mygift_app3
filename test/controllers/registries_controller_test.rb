...
class RegistriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registry" do
    assert_difference('Registry.count') do
      post registries_url, params: { registry: { due_date: @registry.due_date, title: @registry.title, user_id: @registry.user_id, welcome_message: @registry.welcome_message } }
    end
  ...
  test "should update registry" do
    patch registry_url(@registry), params: { registry: { due_date: @registry.due_date, title: @registry.title, user_id: @registry.user_id, welcome_message: @registry.welcome_message } }
