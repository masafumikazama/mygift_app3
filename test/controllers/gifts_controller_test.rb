...
class GiftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gift" do
    assert_difference('Gift.count') do
      post gifts_url, params: { gift: { description: @gift.description, registry_id: @gift.registry_id, target_price: @gift.target_price, title: @gift.title } }
    end
  ...
  test "should update gift" do
    patch gift_url(@gift), params: { gift: { description: @gift.description, registry_id: @gift.registry_id, target_price: @gift.target_price, title: @gift.title } }
